...
export function Footer() {
    return (
        <footer className="bg-primary dark:bg-slate-900 text-white pt-16 pb-8">
            <div className="container mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 dark:text-gray-300 text-sm mb-4">Subscribe to receive updates, access to exclusive deals, and more.</p>
                        <form className="flex gap-2">
                            <input
                                type="email"
                                placeholder="Enter your email"
                                className="bg-white/10 dark:bg-white/5 border border-white/20 rounded-md px-3 py-2 text-sm text-white placeholder:text-gray-400 focus:outline-none focus:border-secondary flex-1"
                            />
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex space-x-6">
                        <Link href="#" className="text-gray-400 dark:text-gray-300 hover:text-secondary transition-colors"><Facebook size={18} /></Link>
                        <Link href="#" className="text-gray-400 dark:text-gray-300 hover:text-secondary transition-colors"><Instagram size={18} /></Link>
                        <Link href="#" className="text-gray-400 dark:text-gray-300 hover:text-secondary transition-colors"><Twitter size={18} /></Link>
                    </div>
                </div>
            </div>
        </footer>
